...
export async function CreateManagement(req, res) {
  try {
    ...
    return res
      .status(200)
      .json(
        new ApiResponse(200, savedManagement, "management created successfully")
      );
  } catch (error) {
    return res
      .status(500)
...
export async function GetManagement(req, res) {
  try {
    ...
    return res
      .status(200)
      .json(
        new ApiResponse(200, response, "Management generated successfully")
      );
  } catch (error) {
    return res
      .status(500)
...
export async function GetManagementById(req, res) {
  try {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, response, "Management generated by id"));
  } catch (error) {
    return res
      .status(500)
      .json(new ApiResponse(500, null, "Internal Server Error"));
